#创建数据库
drop database TLandPartner;
create database TLandPartner;
use TLandPartner;
#创建表
#用户表
create table t_user(
...
("万科·蓝山","新城央，新蓝图","/Img/蓝山.jpg","http://wanke.leweike.com/discription01.html",100,now(),now()),
("长春万科城","百万平米都市生态城","/Img/长春万科城.jpg","http://wanke.leweike.com/discription04.html",200,now(),now()),
("万科·金域长春","市府都心、公园之央","/Img/金域长春.jpg","http://wanke.leweike.com/discription03.html",300,now(),now()),
("万科·柏翠园","心生大境之园","/Img/柏翠园.jpg","http://wanke.leweike.com/discription02.html",400,now(),now()),
("万科·惠斯勒小镇","北美山地小镇","/Img/惠斯勒.jpg","http://wanke.leweike.com/discription05.html",500,now(),now()),
("吉林万科城","吉林万科滨江城","/Img/吉林万科城.jpg","http://wanke.leweike.com/discription06.html",500,now(),now());
...
('{"addressList":[{"mail":"18503082346@163.com","name":"fishedee"},{"mail":"306766045@qq.com","name":"fish"}],"html":"/var/www/idc/View/AddDealMail.php","subject":"abc","data":"测试"}',2,1,now(),now());
select * from t_admin;
select * from t_user;
