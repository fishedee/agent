...
(function (global, document, undefined) {
    ...
    DataTable.fn = DataTable.prototype = {
        ...
        createJsonTable:function (_this) {
            ...
            var paramStr = 'pageFrom=' + _pageFrom + "&pageSize=" + _this.page.size + "&orderField=" + _this.page.orderField + "&orderType=" + _this.page.orderType + "&t=" + Math.random();
