<?php
	...
	define ( "MAIL_USER_NAME", "长春万科金牌代理人平台" );
	define ( "MAIL_USER_TITLE", "长春万科金牌代理人平台提醒邮件" );
	define ( "MAIL_DEAL_CONTENT", dirname ( __FILE__ ) . '/../View/AddDealMail.php' );
	// 短信接口的用户名密码
	define ( "SMS_USER", "younggun2002" );
	define ( "SMS_PASS", "rch19780602" );
	define ( "SMS_VALID_CONTENT", "您的金牌代理人注册验证码为%s，请完成验证。如非本人操作，请忽略本短信。" );
	define ( "SMS_DEAL_CONTENT", "恭喜您，您已经被%s号金牌代理人推荐至%s项目，金牌代理人电话%s，到访第一时间请出示本短信。" );
	define ( "SMS_REGISTER_CONTENT", "您提交的金牌代理人信息注册已成功, 审核通过后将为您发送代理人专属代码。" );
	define ( "SMS_VERTIFY_CONTENT", "恭喜您成为万科金牌代理人，您的代理人专属代码为%s。" );
	define ( "SMS_VERTIFY_FAIL_CONTENT", "您提交的金牌代理人注册信息暂未通过审核，请您再次核实您提供的信息或致电0431-89188335详询。" );
	define ( "SMS_VERTIFY_CANCEL_CONTENT", "您提交的金牌代理人注册信息已注销，如有疑问请致电0431-89188335详询。" );
	// 数据库连接常量
	define ( "MYSQL_ADDRESS", "localhost" );
	define ( "MYSQL_PORT", 3306 );
	define ( "MYSQL_USER", "root" );
	define ( "MYSQL_PASS", "1" );
	define ( "MYSQL_DB", "agentDev" );
	// 数据库表名常量
